...
import io.github.drumber.kitsune.data.source.jsonapi.library.api.LibraryEntryApi
...
import io.github.drumber.kitsune.data.source.local.AccessTokenPreference
import io.github.drumber.kitsune.data.source.local.UserPreferences
...
val dataModule = module {
    ...
    single { LibraryPagingRepository(get(), get(), get()) }
