...
class PinnedPostAdapter(
    ...
    inner class PostViewHolder(private val binding: ItemPostBinding) :
        ...
        private fun likeViaDoubleTap(post: Post) {
            val current = interactionOverride.isLiked ?: false
            if (current) return
            val currentCount = interactionOverride.likesCount ?: post.likesCount
        ...
        fun bind(post: Post) {
            ...
            val isLiked = interactionOverride.isLiked ?: false
            val likesCount = interactionOverride.likesCount ?: post.likesCount
            val commentsCount = interactionOverride.commentsCount ?: post.commentsCount
        ...
        private fun bindLikerAvatars(post: Post) {
            ...
            val avatars = interactionOverride.likerAvatars.orEmpty()
            ...
            val totalLikes = interactionOverride.likesCount ?: post.likesCount
